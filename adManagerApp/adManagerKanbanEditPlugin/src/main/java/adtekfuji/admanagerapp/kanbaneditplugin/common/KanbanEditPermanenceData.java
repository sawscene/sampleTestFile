 ...
 * @author ta.ito
 */
public class KanbanEditPermanenceData {

    private final Logger logger = LogManager.getLogger();
    private final Properties properties = AdProperty.getProperties();
    private static KanbanEditPermanenceData instance = null;
    ...
    private Long selectedKanbanId = null;


    private KanbanEditPermanenceData() {
    }

    public static KanbanEditPermanenceData getInstance() {
        if (Objects.isNull(instance)) {
            instance = new KanbanEditPermanenceData();
        }
        return instance;
    }
    ...
    public Long getSelectedKanbanId() {
        return selectedKanbanId;
    }

    public void setSelectedKanban(Long selectedKanbanId) {
        this.selectedKanbanId = selectedKanbanId;
    }
