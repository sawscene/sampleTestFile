...
public class ProductPlanInfoEntity implements Serializable {
    ...
    public ProductPlanInfoEntity(String itemName, String itemCode, String nickName, String workNumber, String workCode, String equipmentIdentify, String assertNum, Date compDatetime, Long productionNumber) {
