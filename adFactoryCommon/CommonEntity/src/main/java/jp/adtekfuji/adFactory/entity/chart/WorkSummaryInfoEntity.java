...
public class WorkSummaryInfoEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WorkSummaryInfoEntity)) {
            return false;
        }
        WorkSummaryInfoEntity other = (WorkSummaryInfoEntity) object;
    ...
    public String toString() {
        return new StringBuilder("WorkSummaryInfoEntity{")
