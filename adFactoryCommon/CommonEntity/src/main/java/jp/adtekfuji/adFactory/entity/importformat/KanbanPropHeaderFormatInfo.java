...
/**
 * CSV形式（ヘッダー名指定）_カンバンプロパティのフォーマット情報
 *
 * @author (AQTOR)Koga
 */
@XmlRootElement(name = "kanbanPropHeaderFormatInfo")
@XmlAccessorType(XmlAccessType.FIELD)
public class KanbanPropHeaderFormatInfo {
     ...
     * コンストラクタ
     */
    public KanbanPropHeaderFormatInfo() {
    }
    ...
    public String toString() {
        return new StringBuilder("kanbanPropHeaderFormatInfo{")
