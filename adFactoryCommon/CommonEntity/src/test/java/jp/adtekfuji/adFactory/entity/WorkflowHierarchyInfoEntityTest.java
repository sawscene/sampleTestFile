 ...
 * @author ta.ito
 */
public class WorkflowHierarchyInfoEntityTest {

    public WorkflowHierarchyInfoEntityTest() {
    }
    ...
    public void testXml() throws Exception {
        ...
        WorkflowHierarchyInfoEntity entity = new WorkflowHierarchyInfoEntity(1L, "name");
        entity.setParentId(2L);
        Document xml = EntityToXml.getXml(entity);

        String[] expectedNode1 = {"workflowHierarchy"};
        String[] expectedNode2 = {"workflowHierarchyId", "parentId", "hierarchyName", "childCount"};
    ...
    public void testBindProperty() throws ConfigurationException, IOException {
        ...
        WorkflowHierarchyInfoEntity hierarchy1 = new WorkflowHierarchyInfoEntity(1L, "name1");
        WorkflowHierarchyInfoEntity hierarchy2 = new WorkflowHierarchyInfoEntity(2L, "name2");
        assertThat(hierarchy1.getWorkflowHierarchyId(), is(1l));
        assertThat(hierarchy1.getHierarchyName(), is("name1"));
        assertThat(hierarchy2.getWorkflowHierarchyId(), is(2l));
        assertThat(hierarchy2.getHierarchyName(), is("name2"));

        hierarchy2.workflowHierarchyIdProperty().bind(hierarchy1.workflowHierarchyIdProperty());
        hierarchy2.hierarchyNameProperty().bind(hierarchy1.hierarchyNameProperty());
        hierarchy1.setWorkflowHierarchyId(3L);
        hierarchy1.setHierarchyName("name3");
        assertThat(hierarchy1.getWorkflowHierarchyId(), is(3l));
        assertThat(hierarchy1.getHierarchyName(), is("name3"));
        assertThat(hierarchy2.getWorkflowHierarchyId(), is(3l));
